...
import ProjectCard from "./PreviousProject";
    ...
    <div className="space-y-4 max-h-120 max-w-150 overflow-y-auto">
      <Tabs defaultValue="project" className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="project" className="cursor-pointer">Project Overview</TabsTrigger>
          <TabsTrigger value="author" className="cursor-pointer">About Me</TabsTrigger>
        </TabsList>

        <TabsContent value="project" className="space-y-4 py-4">
          <div className="prose prose-sm max-w-none">
            <div className="relative w-full h-64 overflow-hidden mb-3.5">
              <Image
            ...
            <p className="text-gray-600 leading-normal text-wrap">
              A cozy, minimal space with no fancy desk setup—so you can stay focused and get your daily tasks done 🥲. This interactive 3D portfolio explores
            ...
            <h4 className="text-md font-semibold mt-6 mb-1.5">
              Technologies Used
            </h4>
        ...
        <TabsContent value="author" className="space-y-4 py-4">
          <div className="prose prose-sm max-w-none">
            ...
            <h3 className="text-lg font-semibold mt-6mb-1">About Me</h3>
            ...
            <h3 className="text-lg font-semibold mt-6 mb-1">Previous Project</h3>
            <div className="flex flex-col gap-2">
              <ProjectCard
    title="StayWise – Property Renting App"
    description="A web-based property renting platform that simplifies the connection between property owners and guests."
    image="/assets/Staywise-thumbnail.webp"
    href="https://www.staywise.rent/"
  />
  <ProjectCard
    title="Yacons Design - 3D Assets Library"
    description="Explore my premium 3D assets creation"
    image="/assets/yacons-thumbnail.webp"
